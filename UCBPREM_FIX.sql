...
update ucbprem
   set ucbprem_activity_date = to_date('13-JAN-2012 01:01:01','dd-MON-yyyy HH:MI:SS')
where ucbprem_code = '2008246' 
and   ucbprem_user_id = 'DRIXEN2'
and   ucbprem_activity_date = to_date('13-JAN-2012','dd-MON-yyyy')
